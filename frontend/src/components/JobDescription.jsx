  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      <div className="flex items-center justify-between">
        ...
        disabled={isapplied}
        variant="destructive" 
        className={` text-white rounded-lg ${isapplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-purple-900 hover:bg-purple-600'}` }>
            {
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1 ">Description:  <span className="pl-4 font-normal text-gray-800">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quisquam quia impedit distinctio?</span></h1>
        ...
        <h1 className="font-bold my-1 ">Posted Date:  <span className="pl-4 font-normal text-gray-800">17-07-24</span></h1>
      </div>
    </div>
  );
};
